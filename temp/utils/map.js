 ...
 * @return {Object} - 返回一个对象，其中包含：
 * @property {number[]} centerLonLat - 中心点经纬度，格式为 [经度, 纬度]。
 * @property {number} distance - 距离（单位：米）。
 *
 * @example
 * // 示例：计算两个经纬度之间的距离
 ...
 * @returns {Array<Array<number>>} 四个新点的坐标数组，格式为 [[经度1, 纬度1], [经度2, 纬度2], ...]
 *
 * @example
