...
export declare class Http {
     ...
     * ```
     */
    request<TResponse, T = unknown>(endpoint: string, config?: RequestConfig<T>): Promise<ApiResponse<TResponse>>;
    /**
     * 发送 GET 请求获取资源
     * @public
     *
     ...
     * ```
     */
    get<TResponse>(endpoint: string, config?: Omit<RequestConfig, 'data' | 'method'>): Promise<ApiResponse<TResponse>>;
    /**
       * 发送 POST 请求创建资源
       * @public
       *
       ...
       * ```
       */
    post<TResponse, T = unknown>(endpoint: string, data?: T, config?: Omit<RequestConfig, 'data' | 'method'>): Promise<ApiResponse<TResponse>>;
    /**
       * 发送 PUT 请求更新资源
       * @public
       *
       ...
       * ```
       */
    put<TResponse, T = unknown>(endpoint: string, data?: T, config?: Omit<RequestConfig, 'data' | 'method'>): Promise<ApiResponse<TResponse>>;
    /**
     * 发送 DELETE 请求删除资源
     * @public
     *
     ...
     * ```
     */
    delete<TResponse>(endpoint: string, config?: Omit<RequestConfig, 'data' | 'method'>): Promise<ApiResponse<TResponse>>;
}
/**
 ...
 * ```
 */
export declare const URLSearchParamsUtils: (data: {
    [key: string]: any;
}) => string;
